...
class DataEngineStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetPlotData = channel.unary_unary(
                '/tableservices.DataEngine/GetPlotData',
                request_serializer=table__pb2.Query.SerializeToString,
                response_deserializer=table__pb2.DoubleValue.FromString,
                )
...
def add_DataEngineServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'tableservices.DataEngine', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
...
class DataEngine(object):
    ...
    def GetPlotData(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/tableservices.DataEngine/GetPlotData',
            table__pb2.Query.SerializeToString,
            table__pb2.DoubleValue.FromString,
            options, channel_credentials,
            call_credentials, compression, wait_for_ready, timeout, metadata)
